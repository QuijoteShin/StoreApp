...
import { updateComponentState, saveITStatusToServer } from '../../actions/index'
...
class StoreDetailsView extends Component {
    ...
    saveStoreDetailView(detailViewData) {
        console.log('Details View Store', this.props.store ,'Details View IT Status State', this.props.itStatus)
        const store = this.props.store
        const itStatus = this.props.itStatus
        const storePlusItStatus = Object.assign(store, itStatus)
        //console.log('storePlusItStatus Object Assign', storePlusItStatus)
        this.props.dispatch(saveITStatusToServer(storePlusItStatus))
    }
